...
export default {
  ...
  async sendPostRequest(): Promise<void> {
    try {
      const response = await fetch("https://api.containers.back4app.com/", {
        method: "POST",
        headers: {
          "accept": "*/*",
